...
from .attention_processor2 import Attention as Attention2
...
class TemporalBasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        if self.attn2 is not None:
            norm_hidden_states = self.norm2(hidden_states)
            attn_output, cross_attention = self.attn2(norm_hidden_states, encoder_hidden_states=encoder_hidden_states)
            hidden_states = attn_output + hidden_states
