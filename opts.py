...
def get_args_parser():
    parser = argparse.ArgumentParser('VDIT training and inference scripts.', add_help=False)
    ...
    parser.add_argument('--text_backbone', default='Roberta', type=str,
                        help="Name of the convolutional backbone to use")
    parser.add_argument('--backbone_pretrained', default='./swin_base_patch244_window877_kinetics600_22k.pth', type=str, 
    ...
    parser.add_argument('--davis_path', type=str, default='./data/refer_davis')
